...
function Navbar(){
  ...
  return (
    ...
    <div className="navbar bg-base-30">
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer">Eboo.K</a>
  </div>
  ...
  <input type="checkbox" onClick={()=>settheme(theme==="light"?"dark":"light")} className="theme-controller" value="synthwave" />
  ...
  <div className="">
    <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 durstion-300 cursor-pointer" onClick={()=>document.getElementById('my_modal_3').showModal()}>Login</a>
    <Login/>
  </div>
  </div>
</div>
